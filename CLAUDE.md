...
Current: v1.0.0 -- 1490 tests passing. v1.0.0 is the first release under the binding stability promise (Constitution Chapter VI); the names listed in `specs/v1.0.0-stability.md` §1 follow strict semver from this point on. Major features:
